        ...
        <div className="flex justify-center items-center w-full  ">
          <div className="flex flex-col lg:flex-row justify-center  items-center gap-6">
            ...
            <div className="flex flex-col justify-center items-center lg:items-start gap-2 ">
              <h1 className="text-darkColor text-[18px] md:text-[20px] font-bold tracking-[0.165rem]">
                Vishnu K
              </h1>
              <span className="flex text-center lg:text-left text-[16px] md:text-[18px] font-semibold  divide-x-2 divide-lightColor">
              ...
              <p className="text-lightColor text-justify lg:text-left text-[14px] md:text-[16px] font-normal tracking-[0.07rem]">
              ...
              <span className="text-left lg:text-left text-[14px] md:text-[16px] font-normal tracking-[0.07rem]">
